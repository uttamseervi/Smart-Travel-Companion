            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div className="relative">
                ...
                <Select onValueChange={(value) => setSelectedLocations([value])}>
                  <SelectTrigger className="pl-10 bg-white/10 backdrop-blur-md border-white/20 text-white">
                                ...
                                <div className="grid gap-4 py-4">
                                  ...
                                  <div className="grid grid-cols-1 gap-2">
                                    ...
                                    <Select
                                      ...
                                      onValueChange={(time) => setBookingDetails({...bookingDetails, time})}
                                    >
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    <div className="grid grid-cols-1 gap-2">
                                      ...
                                      <Select
                                        ...
                                        onValueChange={(val) => setBookingDetails({...bookingDetails, adults: parseInt(val)})}
                                      >
                                    ...
                                    <div className="grid grid-cols-1 gap-2">
                                      ...
                                      <Select
                                        ...
                                        onValueChange={(val) => setBookingDetails({...bookingDetails, children: parseInt(val)})}
                                      >
